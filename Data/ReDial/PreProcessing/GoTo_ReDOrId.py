...
UiD_data = pd.read_csv('/Users/nicholas/ReDial_A19/Data/ReDial/RecoText_SR_all_ratings/Train.csv'\
                       ).values
...
df.to_csv('/Users/nicholas/ReDial_A19/Data/ReDial/RecoText_SR_all_ratings_ReDOrId/Train.csv', index=False)
