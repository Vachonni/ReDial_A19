...
UiD_data = pd.read_csv('/Users/nicholas/ReDial_A19/Data/ReDial/ChronoTextSRGenres/Train.csv' \
                       ).values
...
df.to_csv('/Users/nicholas/ReDial_A19/Data/ReDial/ChronoTextSRGenres_ReDOrId/Train.csv', index=False)
